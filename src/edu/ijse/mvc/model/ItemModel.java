...
public class ItemModel {
    public String addItem(ItemDto itemDto)throws ClassNotFoundException, SQLException{
        ...
        return statement.executeUpdate() > 0 ? "Item Added Successfully" : "Faild to Add Item";
    }
    ...
    public String deleteItem(String itemCode)throws ClassNotFoundException, SQLException{
        ...
        return statement.executeUpdate()> 0 ? "Item Deleted Successfully" : "Faild to Delete Item";
    }
    ...
    public ArrayList<ItemDto> getAll()throws ClassNotFoundException, SQLException{
        ...
        while(rst.next()){
            ItemDto dto = new ItemDto(rst.getString("ItemCode"), rst.getString("Description"), rst.getString("PackSize"), rst.getInt("QtyOnHand"), rst.getDouble("UnitPrice"));
            itemDtos.add(dto);
        }
